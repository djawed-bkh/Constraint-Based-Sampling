...
public class ConstraintGenerator {
    ...
    public ConstraintGenerator(Database db, int constraintNumber, int genratorType) {
    ...
    public ConstraintGenerator(Database db, int constraintNumber, int genratorType, boolean Distinctvaluesorder) {
    ...
    public ArrayList<Constraint> UserBasedConstraints(int constraintNumber) {
...
//        constraintsOrderSelection(Query,constSelectionType);
    ...
    public void AttributeOrderSelection(int attSelectionType, ArrayList<Integer> AttList) {
        ...
        if (attSelectionType == 1) {
            SortAttList(AttList, true);         // sort in an ascending or descending order of number of distinct values
        } else if (attSelectionType == 2) {
            SortAttList(AttList, false);         // sort in an ascending or descending order of number of distinct values
        } else {                                                  // shuffle attributes
